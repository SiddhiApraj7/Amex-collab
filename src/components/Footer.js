...
const Footer = () => {
  ...
  return (
    <View className="bg-white rounded-lg pt-1 h-14" style={{position: 'absolute', left:0, right:0, bottom:0, flex:1}}>
          ...
          <TouchableOpacity className="text-center items-center"><Ionicons name="home-outline" size={20}></Ionicons><Text className="text-xs text-black">Dashboard</Text></TouchableOpacity>
